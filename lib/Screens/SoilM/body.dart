...
class _StatefulWidgetState extends State<Body> {
  ...
  Widget build(BuildContext context) {
   ...
   Future<void> chkMvalue() async {
    ...
    if (Pval < 10) {
      ShowNotification(
          id: 0, title: "Toprak Nemlendirici", body: "Toprak su seviyesi düşüyor");

      ShowNotification(
          id: 1, title: "Toprak Nemlendirici", body: "Solenoid valfi açın");

      LoginScreen.twilioFlutter.sendSMS(
          toNumber: LoginScreen.loggedcontat!,
          messageBody: "Toprak su seviyesi düşüyor\nSolenoid valfi açın");
    }
  }
