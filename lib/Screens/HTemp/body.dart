...
class _StatefulWidgetDemoState extends State<Body> {
  ...
  Future<void> chkTvalue() async {
    ...
    if (Eval > 35 ) {
      ShowNotification(
          id: 0, title: "Sıcaklık", body: "Ortam Sıcaklığı Yüksek");
      ShowNotification(
          id: 1, title: "Sıcaklık", body: "Solenoid valfi açın");

          LoginScreen.twilioFlutter.sendSMS(
                                      toNumber: LoginScreen.loggedcontat! ,
                                      messageBody:"Ortam Sıcaklığı Yüksek\nSolenoid valfi açın");
  ...
  Future<void> chkHvalue() async {
    ...
    if (Hval > 80) {
      ShowNotification(
          id: 2, title: "Nem", body: "Ortam Nemi Yüksek");
           LoginScreen.twilioFlutter.sendSMS(
          toNumber: LoginScreen.loggedcontat!,
          messageBody:
              "Ortam Nemi Yüksek");
  ...
  Future<void> chkSTvalue() async {
    ...
    if (STval > 15) {
      ShowNotification(
          id: 3, title: "Toprak Sıcaklığı", body: "Toprak Sıcaklığı Yüksek");
      ShowNotification(
          id: 4, title: "Toprak Sıcaklığı", body: "Solenoid valfi açın");

              LoginScreen.twilioFlutter.sendSMS(
          toNumber: LoginScreen.loggedcontat!,
          messageBody: "Toprak Sıcaklığı Yüksek\nSolenoid valfi açın");
    }
  }
